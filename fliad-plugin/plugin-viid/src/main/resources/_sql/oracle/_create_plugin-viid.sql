...
CREATE TABLE viid_ape(
  ...
  APEID VARCHAR2(64) NOT NULL ,
  NAME VARCHAR2(128) NOT NULL ,
  MODEL VARCHAR2(64) NOT NULL ,
  IPADDR VARCHAR2(64) NOT NULL ,
  IPV6ADDR VARCHAR2(128)  ,
  PORT INTEGER NOT NULL ,
  LONGITUDE NUMBER(10,6) NOT NULL ,
  LATITUDE NUMBER(10,6) NOT NULL ,
  PLACECODE VARCHAR2(12) NOT NULL ,
  PLACE VARCHAR2(256)  ,
  ORGCODE VARCHAR2(64)  ,
  CAPDIRECTION CHAR(1)  ,
  MONITORDIRECTION VARCHAR2(32)  ,
  MONITORAREADESC VARCHAR2(256)  ,
  ISONLINE CHAR(1) NOT NULL ,
  OWNERAPSID VARCHAR2(64)  ,
  USERID VARCHAR2(64)  ,
  PASSWORD VARCHAR2(128)  ,
  FUNCTIONTYPE VARCHAR2(64) NOT NULL ,
  POSITIONTYPE VARCHAR2(128)  ,
...
CREATE TABLE viid_cascade_platform(
  ...
  KEEPALIVE_TIMEOUT_COUNT INTEGER  ,
  constraint PK_viid_cascade_platform primary key (ID)
);

CREATE TABLE viid_subscribe(
  SUBSCRIBEID VARCHAR2(40) NOT NULL ,
  TITLE VARCHAR2(255)  ,
  SUBSCRIBEDETAIL VARCHAR2(255)  ,
  RESOURCEURI VARCHAR2(255)  ,
  APPLICANTNAME VARCHAR2(50)  ,
  APPLICANTORG VARCHAR2(50)  ,
  BEGINTIME VARCHAR2(15)  ,
  ENDTIME VARCHAR2(15)  ,
  RECEIVEADDR VARCHAR2(255)  ,
  REPORTINTERVAL INTEGER  ,
  REASON VARCHAR2(255)  ,
  OPERATETYPE VARCHAR2(5)  ,
  SUBSCRIBESTATUS VARCHAR2(5)  ,
  SUBSCRIBECANCELORG VARCHAR2(50)  ,
  SUBSCRIBECANCELPERSON VARCHAR2(32)  ,
  CANCELTIME DATE  ,
  CANCELREASON VARCHAR2(64)  ,
  SUBSCRIBETYPE VARCHAR2(1)  ,
  SUBSCRIBERSENDORGID VARCHAR2(255)  ,
  SUBSCRIBERRECOVERORGID VARCHAR2(255)  ,
...
CREATE TABLE viid_subscribe_notifications(
  ...
  SUBSCRIBEID VARCHAR2(64) NOT NULL ,
  TITLE VARCHAR2(256)  ,
  TRIGGERTIME DATE  ,
  INFOIDS VARCHAR2(512)  ,
  REQUESTDATA CLOB  ,
  RESPONSEDATA CLOB  ,
  REQUESTCOST INTEGER  ,
...
CREATE TABLE viid_tollgate(
  ID VARCHAR2(20) NOT NULL ,
  TOLLGATEID VARCHAR2(64) NOT NULL ,
  NAME VARCHAR2(128) NOT NULL ,
  LONGITUDE NUMBER(10,6) NOT NULL ,
  LATITUDE NUMBER(10,6) NOT NULL ,
  ...
  TOLLGATECAT VARCHAR2(32) NOT NULL ,
  TOLLGATEUSAGE SMALLINT NOT NULL ,
  LANENUM INTEGER  ,
  ORGCODE VARCHAR2(32)  ,
  ACTIVETIME DATE  ,
