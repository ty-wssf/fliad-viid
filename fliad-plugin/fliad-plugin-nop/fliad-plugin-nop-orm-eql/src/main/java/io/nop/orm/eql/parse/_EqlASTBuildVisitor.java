...
public List<io.nop.orm.eql.ast.SqlCaseWhenItem> buildCaseWhens_(CaseWhens_Context ctx){
    List<io.nop.orm.eql.ast.SqlCaseWhenItem> list = new ArrayList<>();
...
public List<io.nop.orm.eql.ast.SqlColumnName> buildColumnNames_(ColumnNames_Context ctx){
    List<io.nop.orm.eql.ast.SqlColumnName> list = new ArrayList<>();
...
public List<io.nop.orm.eql.ast.SqlLiteral> buildDecoratorArgs_(DecoratorArgs_Context ctx){
    List<io.nop.orm.eql.ast.SqlLiteral> list = new ArrayList<>();
...
public List<io.nop.orm.eql.ast.SqlExpr> buildFunctionArgs_(FunctionArgs_Context ctx){
    List<io.nop.orm.eql.ast.SqlExpr> list = new ArrayList<>();
...
public List<io.nop.orm.eql.ast.SqlAssignment> buildSqlAssignments_(SqlAssignments_Context ctx){
    List<io.nop.orm.eql.ast.SqlAssignment> list = new ArrayList<>();
...
public List<io.nop.orm.eql.ast.SqlCteStatement> buildSqlCteStatements_(SqlCteStatements_Context ctx){
    List<io.nop.orm.eql.ast.SqlCteStatement> list = new ArrayList<>();
...
public List<io.nop.orm.eql.ast.SqlDecorator> buildSqlDecorators_(SqlDecorators_Context ctx){
    List<io.nop.orm.eql.ast.SqlDecorator> list = new ArrayList<>();
...
public List<io.nop.orm.eql.ast.SqlGroupByItem> buildSqlGroupByItems_(SqlGroupByItems_Context ctx){
    List<io.nop.orm.eql.ast.SqlGroupByItem> list = new ArrayList<>();
...
public List<io.nop.orm.eql.ast.SqlExpr> buildSqlInValues_(SqlInValues_Context ctx){
    List<io.nop.orm.eql.ast.SqlExpr> list = new ArrayList<>();
    List<SqlExprContext> elms = ctx.sqlExpr();
    if(elms != null){
      for(SqlExprContext elm: elms){
...
public List<io.nop.orm.eql.ast.SqlOrderByItem> buildSqlOrderByItems_(SqlOrderByItems_Context ctx){
    List<io.nop.orm.eql.ast.SqlOrderByItem> list = new ArrayList<>();
...
public List<io.nop.orm.eql.ast.SqlExpr> buildSqlPartitionByItems_(SqlPartitionByItems_Context ctx){
    List<io.nop.orm.eql.ast.SqlExpr> list = new ArrayList<>();
    List<SqlExprContext> elms = ctx.sqlExpr();
    if(elms != null){
      for(SqlExprContext elm: elms){
...
public List<io.nop.orm.eql.ast.SqlProjection> buildSqlProjections_(SqlProjections_Context ctx){
    List<io.nop.orm.eql.ast.SqlProjection> list = new ArrayList<>();
...
public List<io.nop.orm.eql.ast.SqlStatement> buildSqlStatements_(SqlStatements_Context ctx){
    List<io.nop.orm.eql.ast.SqlStatement> list = new ArrayList<>();
...
public List<io.nop.orm.eql.ast.SqlExpr> buildSqlValues_(SqlValues_Context ctx){
    List<io.nop.orm.eql.ast.SqlExpr> list = new ArrayList<>();
    List<SqlExprContext> elms = ctx.sqlExpr();
    if(elms != null){
      for(SqlExprContext elm: elms){
...
public List<io.nop.orm.eql.ast.SqlTableSource> buildTableSources_(TableSources_Context ctx){
    List<io.nop.orm.eql.ast.SqlTableSource> list = new ArrayList<>();
   ...
   * rules: sqlAggregateFunction
   */
  public abstract String SqlAggregateFunction_name(ParseTree node);

  /**
   * rules: sqlAlias
   */
  public abstract String SqlAlias_alias(ParseTree node);

  /**
   * rules: sqlBitValueLiteral
   */
  public abstract String SqlBitValueLiteral_value(org.antlr.v4.runtime.Token token);

  /**
   * rules: sqlColumnName
   */
  public abstract String SqlColumnName_name(ParseTree node);

  /**
   * rules: sqlCteStatement
   */
  public abstract String SqlCteStatement_name(ParseTree node);

  /**
   * rules: sqlDateTimeLiteral
   */
  public abstract String SqlDateTimeLiteral_value(org.antlr.v4.runtime.Token token);

  /**
   * rules: sqlDecorator
   */
  public abstract String SqlDecorator_name(ParseTree node);

  /**
   * rules: sqlHexadecimalLiteral
   */
  public abstract String SqlHexadecimalLiteral_value(org.antlr.v4.runtime.Token token);

  /**
   * rules: sqlNumberLiteral
   */
  public abstract String SqlNumberLiteral_value(org.antlr.v4.runtime.Token token);

  /**
   * rules: sqlQualifiedName
   */
  public abstract String SqlQualifiedName_name(ParseTree node);

  /**
   * rules: sqlRegularFunction
   */
  public abstract String SqlRegularFunction_name(ParseTree node);

  /**
   * rules: sqlStringLiteral
   */
  public abstract String SqlStringLiteral_value(org.antlr.v4.runtime.Token token);

  /**
   * rules: sqlTableName
   */
  public abstract String SqlTableName_name(ParseTree node);

  /**
   * rules: sqlTypeExpr
   */
  public abstract String SqlTypeExpr_characterSet(ParseTree node);

  /**
   * rules: sqlTypeExpr
   */
  public abstract String SqlTypeExpr_collate(ParseTree node);

  /**
   * rules: sqlTypeExpr
   */
  public abstract String SqlTypeExpr_name(ParseTree node);
