	...
	public EqlASTNode optimizeSqlProgram(SqlProgram node, C context){
        SqlProgram ret = node;
                    ...
                    if(node.getStatements() != null){
                            ...
                            java.util.List<SqlStatement> statementsOpt = optimizeList(node.getStatements(),true, context);
	...
	public EqlASTNode optimizeSqlQualifiedName(SqlQualifiedName node, C context){
        SqlQualifiedName ret = node;
                    ...
                    if(node.getNext() != null){
                            ...
                            SqlQualifiedName nextOpt = (SqlQualifiedName)optimize(node.getNext(),context);
	...
	public EqlASTNode optimizeSqlTableName(SqlTableName node, C context){
        SqlTableName ret = node;
                    ...
                    if(node.getOwner() != null){
                            ...
                            SqlQualifiedName ownerOpt = (SqlQualifiedName)optimize(node.getOwner(),context);
	...
	public EqlASTNode optimizeSqlInsert(SqlInsert node, C context){
        SqlInsert ret = node;
                    ...
                    if(node.getDecorators() != null){
                            ...
                            java.util.List<SqlDecorator> decoratorsOpt = optimizeList(node.getDecorators(),true, context);
                    ...
                    if(node.getTableName() != null){
                            ...
                            SqlTableName tableNameOpt = (SqlTableName)optimize(node.getTableName(),context);
                    ...
                    if(node.getColumns() != null){
                            ...
                            java.util.List<SqlColumnName> columnsOpt = optimizeList(node.getColumns(),true, context);
                    ...
                    if(node.getSelect() != null){
                            ...
                            SqlSelect selectOpt = (SqlSelect)optimize(node.getSelect(),context);
                    ...
                    if(node.getValues() != null){
                            ...
                            SqlValues valuesOpt = (SqlValues)optimize(node.getValues(),context);
	...
	public EqlASTNode optimizeSqlValues(SqlValues node, C context){
        SqlValues ret = node;
                    ...
                    if(node.getValues() != null){
                            ...
                            java.util.List<SqlExpr> valuesOpt = optimizeList(node.getValues(),true, context);
                            if(valuesOpt != node.getValues()){
                                incChangeCount();
	...
	public EqlASTNode optimizeSqlUpdate(SqlUpdate node, C context){
        SqlUpdate ret = node;
                    ...
                    if(node.getAlias() != null){
                            ...
                            SqlAlias aliasOpt = (SqlAlias)optimize(node.getAlias(),context);
                    ...
                    if(node.getAssignments() != null){
                            ...
                            java.util.List<SqlAssignment> assignmentsOpt = optimizeList(node.getAssignments(),true, context);
                    ...
                    if(node.getWhere() != null){
                            ...
                            SqlWhere whereOpt = (SqlWhere)optimize(node.getWhere(),context);
                    ...
                    if(node.getReturnProjections() != null){
                            ...
                            java.util.List<SqlProjection> returnProjectionsOpt = optimizeList(node.getReturnProjections(),true, context);
	...
	public EqlASTNode optimizeSqlAssignment(SqlAssignment node, C context){
        SqlAssignment ret = node;
                    ...
                    if(node.getColumnName() != null){
                            ...
                            SqlColumnName columnNameOpt = (SqlColumnName)optimize(node.getColumnName(),context);
                    ...
                    if(node.getExpr() != null){
                            ...
                            SqlExpr exprOpt = (SqlExpr)optimize(node.getExpr(),context);
	...
	public EqlASTNode optimizeSqlCteStatement(SqlCteStatement node, C context){
        SqlCteStatement ret = node;
                    ...
                    if(node.getStatement() != null){
                            ...
                            SqlSelect statementOpt = (SqlSelect)optimize(node.getStatement(),context);
	...
	public EqlASTNode optimizeSqlSelectWithCte(SqlSelectWithCte node, C context){
        SqlSelectWithCte ret = node;
                    ...
                    if(node.getWithCtes() != null){
                            ...
                            java.util.List<SqlCteStatement> withCtesOpt = optimizeList(node.getWithCtes(),true, context);
	...
	public EqlASTNode optimizeSqlQuerySelect(SqlQuerySelect node, C context){
        SqlQuerySelect ret = node;
                    ...
                    if(node.getProjections() != null){
                            ...
                            java.util.List<SqlProjection> projectionsOpt = optimizeList(node.getProjections(),true, context);
                    ...
                    if(node.getFrom() != null){
                            ...
                            SqlFrom fromOpt = (SqlFrom)optimize(node.getFrom(),context);
                    ...
                    if(node.getGroupBy() != null){
                            ...
                            SqlGroupBy groupByOpt = (SqlGroupBy)optimize(node.getGroupBy(),context);
                    ...
                    if(node.getHaving() != null){
                            ...
                            SqlHaving havingOpt = (SqlHaving)optimize(node.getHaving(),context);
                    ...
                    if(node.getOrderBy() != null){
                            ...
                            SqlOrderBy orderByOpt = (SqlOrderBy)optimize(node.getOrderBy(),context);
                    ...
                    if(node.getLimit() != null){
                            ...
                            SqlLimit limitOpt = (SqlLimit)optimize(node.getLimit(),context);
	...
	public EqlASTNode optimizeSqlDecorator(SqlDecorator node, C context){
        SqlDecorator ret = node;
                    ...
                    if(node.getArgs() != null){
                            ...
                            java.util.List<SqlLiteral> argsOpt = optimizeList(node.getArgs(),true, context);
	...
	public EqlASTNode optimizeSqlUnionSelect(SqlUnionSelect node, C context){
        SqlUnionSelect ret = node;
                    ...
                    if(node.getLeft() != null){
                            ...
                            SqlSelect leftOpt = (SqlSelect)optimize(node.getLeft(),context);
                    ...
                    if(node.getRight() != null){
                            ...
                            SqlSelect rightOpt = (SqlSelect)optimize(node.getRight(),context);
	...
	public EqlASTNode optimizeSqlPartitionBy(SqlPartitionBy node, C context){
        SqlPartitionBy ret = node;
                    ...
                    if(node.getItems() != null){
                            ...
                            java.util.List<SqlExpr> itemsOpt = optimizeList(node.getItems(),true, context);
	...
	public EqlASTNode optimizeSqlOrderBy(SqlOrderBy node, C context){
        SqlOrderBy ret = node;
                    ...
                    if(node.getItems() != null){
                            ...
                            java.util.List<SqlOrderByItem> itemsOpt = optimizeList(node.getItems(),true, context);
                            if(itemsOpt != node.getItems()){
                                incChangeCount();
                                if(shouldClone(ret,node))  { clearParent(itemsOpt); ret = node.deepClone();}
                                ret.setItems(itemsOpt);
	...
	public EqlASTNode optimizeSqlGroupBy(SqlGroupBy node, C context){
        SqlGroupBy ret = node;
                    ...
                    if(node.getItems() != null){
                            ...
                            java.util.List<SqlGroupByItem> itemsOpt = optimizeList(node.getItems(),true, context);
                            if(itemsOpt != node.getItems()){
                                incChangeCount();
                                if(shouldClone(ret,node))  { clearParent(itemsOpt); ret = node.deepClone();}
                                ret.setItems(itemsOpt);
	...
	public EqlASTNode optimizeSqlLimit(SqlLimit node, C context){
        SqlLimit ret = node;
                    ...
                    if(node.getLimit() != null){
                            ...
                            SqlExpr limitOpt = (SqlExpr)optimize(node.getLimit(),context);
                            if(limitOpt != node.getLimit()){
                               incChangeCount();
                               if(shouldClone(ret,node)) { limitOpt.setASTParent(null); ret = node.deepClone();}
                               ret.setLimit(limitOpt);
                    ...
                    if(node.getOffset() != null){
                            ...
                            SqlExpr offsetOpt = (SqlExpr)optimize(node.getOffset(),context);
	...
	public EqlASTNode optimizeSqlFrom(SqlFrom node, C context){
        SqlFrom ret = node;
                    ...
                    if(node.getTableSources() != null){
                            ...
                            java.util.List<SqlTableSource> tableSourcesOpt = optimizeList(node.getTableSources(),true, context);
	...
	public EqlASTNode optimizeSqlJoinTableSource(SqlJoinTableSource node, C context){
        SqlJoinTableSource ret = node;
                    ...
                    if(node.getLeft() != null){
                            ...
                            SqlTableSource leftOpt = (SqlTableSource)optimize(node.getLeft(),context);
                            if(leftOpt != node.getLeft()){
                               incChangeCount();
                               if(shouldClone(ret,node)) { leftOpt.setASTParent(null); ret = node.deepClone();}
                               ret.setLeft(leftOpt);
                    ...
                    if(node.getRight() != null){
                            ...
                            SqlTableSource rightOpt = (SqlTableSource)optimize(node.getRight(),context);
                            if(rightOpt != node.getRight()){
                               incChangeCount();
                               if(shouldClone(ret,node)) { rightOpt.setASTParent(null); ret = node.deepClone();}
                               ret.setRight(rightOpt);
                    ...
                    if(node.getCondition() != null){
                            ...
                            SqlExpr conditionOpt = (SqlExpr)optimize(node.getCondition(),context);
	...
	public EqlASTNode optimizeSqlSubqueryTableSource(SqlSubqueryTableSource node, C context){
        SqlSubqueryTableSource ret = node;
                    ...
                    if(node.getQuery() != null){
                            ...
                            SqlSelect queryOpt = (SqlSelect)optimize(node.getQuery(),context);
	...
	public EqlASTNode optimizeSqlAndExpr(SqlAndExpr node, C context){
        SqlAndExpr ret = node;
                    ...
                    if(node.getLeft() != null){
                            ...
                            SqlExpr leftOpt = (SqlExpr)optimize(node.getLeft(),context);
                            if(leftOpt != node.getLeft()){
                               incChangeCount();
                               if(shouldClone(ret,node)) { leftOpt.setASTParent(null); ret = node.deepClone();}
                               ret.setLeft(leftOpt);
                    ...
                    if(node.getRight() != null){
                            ...
                            SqlExpr rightOpt = (SqlExpr)optimize(node.getRight(),context);
                            if(rightOpt != node.getRight()){
                               incChangeCount();
                               if(shouldClone(ret,node)) { rightOpt.setASTParent(null); ret = node.deepClone();}
                               ret.setRight(rightOpt);
	...
	public EqlASTNode optimizeSqlCompareWithQueryExpr(SqlCompareWithQueryExpr node, C context){
        SqlCompareWithQueryExpr ret = node;
                    ...
                    if(node.getQuery() != null){
                            ...
                            SqlSubQueryExpr queryOpt = (SqlSubQueryExpr)optimize(node.getQuery(),context);
                            if(queryOpt != node.getQuery()){
                               incChangeCount();
                               if(shouldClone(ret,node)) { queryOpt.setASTParent(null); ret = node.deepClone();}
                               ret.setQuery(queryOpt);
	...
	public EqlASTNode optimizeSqlBetweenExpr(SqlBetweenExpr node, C context){
        SqlBetweenExpr ret = node;
                    ...
                    if(node.getTest() != null){
                            ...
                            SqlExpr testOpt = (SqlExpr)optimize(node.getTest(),context);
                    ...
                    if(node.getBegin() != null){
                            ...
                            SqlExpr beginOpt = (SqlExpr)optimize(node.getBegin(),context);
                    ...
                    if(node.getEnd() != null){
                            ...
                            SqlExpr endOpt = (SqlExpr)optimize(node.getEnd(),context);
	...
	public EqlASTNode optimizeSqlLikeExpr(SqlLikeExpr node, C context){
        SqlLikeExpr ret = node;
                    ...
                    if(node.getValue() != null){
                            ...
                            SqlExpr valueOpt = (SqlExpr)optimize(node.getValue(),context);
                    ...
                    if(node.getEscape() != null){
                            ...
                            SqlExpr escapeOpt = (SqlExpr)optimize(node.getEscape(),context);
	...
	public EqlASTNode optimizeSqlAggregateFunction(SqlAggregateFunction node, C context){
        SqlAggregateFunction ret = node;
                    ...
                    if(node.getArgs() != null){
                            ...
                            java.util.List<SqlExpr> argsOpt = optimizeList(node.getArgs(),true, context);
                            if(argsOpt != node.getArgs()){
                                incChangeCount();
                                if(shouldClone(ret,node))  { clearParent(argsOpt); ret = node.deepClone();}
                                ret.setArgs(argsOpt);
	...
	public EqlASTNode optimizeSqlWindowExpr(SqlWindowExpr node, C context){
        SqlWindowExpr ret = node;
                    ...
                    if(node.getFunction() != null){
                            ...
                            SqlFunction functionOpt = (SqlFunction)optimize(node.getFunction(),context);
                    ...
                    if(node.getPartitionBy() != null){
                            ...
                            SqlPartitionBy partitionByOpt = (SqlPartitionBy)optimize(node.getPartitionBy(),context);
	...
	public EqlASTNode optimizeSqlCaseExpr(SqlCaseExpr node, C context){
        SqlCaseExpr ret = node;
                    ...
                    if(node.getCaseWhens() != null){
                            ...
                            java.util.List<SqlCaseWhenItem> caseWhensOpt = optimizeList(node.getCaseWhens(),true, context);
                    ...
                    if(node.getElseExpr() != null){
                            ...
                            SqlExpr elseExprOpt = (SqlExpr)optimize(node.getElseExpr(),context);
	...
	public EqlASTNode optimizeSqlCaseWhenItem(SqlCaseWhenItem node, C context){
        SqlCaseWhenItem ret = node;
                    ...
                    if(node.getWhen() != null){
                            ...
                            SqlExpr whenOpt = (SqlExpr)optimize(node.getWhen(),context);
                    ...
                    if(node.getThen() != null){
                            ...
                            SqlExpr thenOpt = (SqlExpr)optimize(node.getThen(),context);
	...
	public EqlASTNode optimizeSqlCastExpr(SqlCastExpr node, C context){
        SqlCastExpr ret = node;
                    ...
                    if(node.getDataType() != null){
                            ...
                            SqlTypeExpr dataTypeOpt = (SqlTypeExpr)optimize(node.getDataType(),context);
