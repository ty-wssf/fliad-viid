...
public abstract class _ImportFieldModel extends io.nop.core.resource.component.AbstractComponentModel {
     ...
     * 
     */
    private KeyedList<ImportFieldModel> _fields = KeyedList.emptyList();
     ...
     * 
     */
    private ImportFieldModel _unknownField ;
    ...
    public java.util.List<ImportFieldModel> getFields(){
      return _fields;
    }

    
    public void setFields(java.util.List<ImportFieldModel> value){
        checkAllowChange();
        
        this._fields = KeyedList.fromList(value, ImportFieldModel::getName);
           
    }

    
    public ImportFieldModel getField(String name){
    ...
    public void addField(ImportFieldModel item) {
        checkAllowChange();
        java.util.List<ImportFieldModel> list = this.getFields();
        if (list == null || list.isEmpty()) {
            list = new KeyedList<>(ImportFieldModel::getName);
            setFields(list);
        }
        list.add(item);
    }
    ...
    public void setParentProp(String value){
        checkAllowChange();
    ...
    public Boolean getStripText(){
      return _stripText;
    }

    
    public void setStripText(Boolean value){
        checkAllowChange();
    ...
    public ImportFieldModel getUnknownField(){
      return _unknownField;
    }

    
    public void setUnknownField(ImportFieldModel value){
        checkAllowChange();
