...
public abstract class _SqlNativeFunctionModel extends io.nop.core.resource.component.AbstractComponentModel {
     ...
     * 例如oracle中的sysdate
     */
    private Boolean _hasParenthesis  = true;
    ...
    public void setHasParenthesis(Boolean value){
        checkAllowChange();
    ...
    public Integer getMaxArgCount(){
      return _maxArgCount;
    }

    
    public void setMaxArgCount(Integer value){
        checkAllowChange();
    ...
    public Integer getMinArgCount(){
      return _minArgCount;
    }

    
    public void setMinArgCount(Integer value){
        checkAllowChange();
