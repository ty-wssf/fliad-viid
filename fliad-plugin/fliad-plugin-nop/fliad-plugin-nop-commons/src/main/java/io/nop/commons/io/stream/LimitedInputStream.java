...
import static io.nop.commons.CommonErrors.ARG_MAX_SIZE;
import static io.nop.commons.CommonErrors.ERR_IO_STREAM_SIZE_EXCEED_LIMIT;

// copy from tomcat project
...
public class LimitedInputStream extends FilterInputStream implements Closeable {
    ...
    protected void raiseError(long pSizeMax, long pCount) {
        throw new NopException(ERR_IO_STREAM_SIZE_EXCEED_LIMIT)
                .param(ARG_MAX_SIZE, pSizeMax);
    }
