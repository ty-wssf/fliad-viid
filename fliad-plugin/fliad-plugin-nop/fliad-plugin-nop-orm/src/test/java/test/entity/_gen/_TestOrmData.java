...
public class _TestOrmData extends DynamicOrmEntity{
    ...
    /* : sample_method_id */
    private String _sampleMethodId;
    
    /* : method_param_id */
    private String _methodParamId;
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_sampleMethodId:{
               onInitProp(propId);
               this._sampleMethodId = (String)value;
            ...
            case PROP_ID_methodParamId:{
               onInitProp(propId);
               this._methodParamId = (String)value;
     ...
     * : sample_method_id
     */
    public void setSampleMethodId(String value){
     ...
     * : method_param_id
     */
    public String getMethodParamId(){
     ...
     * : method_param_id
     */
    public void setMethodParamId(String value){
