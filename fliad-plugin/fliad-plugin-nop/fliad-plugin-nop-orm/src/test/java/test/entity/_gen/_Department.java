...
public class _Department extends DynamicOrmEntity{
    ...
    public Department getParent(){
       return (Department)internalGetRefEntity(PROP_NAME_parent);
    }

    public void setParent(Department refEntity){
    ...
    private final OrmEntitySet<Department> _children = new OrmEntitySet<>(this, PROP_NAME_children,
        Department.PROP_NAME_parent, null, Department.class);

    /**
     * 。 refPropName: parent, keyProp: {rel.keyProp}
     */
    public IOrmEntitySet<Department> getChildren(){
       return _children;
    }
