...
import test.entity.TestOrmToOne;
...
public class _TestOrmToOne extends DynamicOrmEntity{
    ...
    public _TestOrmToOne(){
        // for debug
    }

    protected TestOrmToOne newInstance(){
       return new TestOrmToOne();
    }

    @Override
    public TestOrmToOne cloneInstance() {
        TestOrmToOne entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "test.entity.TestOrmToOne";
    }
