...
public class _SimsCollege extends DynamicOrmEntity{
    ...
    private Integer _professionNumber;
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_collegeName:{
               onInitProp(propId);
               this._collegeName = (String)value;
            ...
            case PROP_ID_professionNumber:{
               onInitProp(propId);
               this._professionNumber = (Integer)value;
     ...
     * 专业个数: PROFESSION_NUMBER
     */
    public void setProfessionNumber(Integer value){
