...
public class _SimsTeacher extends DynamicOrmEntity{
    ...
    protected static final List<String> PK_PROP_NAMES = Arrays.asList(PROP_NAME_teacherId);
    protected static final int[] PK_PROP_IDS = new int[]{PROP_ID_teacherId};
    ...
    private String _graduateInstitution;
    
    /* 从业年限: PRACTICE_YEARS */
    private Integer _practiceYears;
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_teacherName:{
               onInitProp(propId);
               this._teacherName = (String)value;
            ...
            case PROP_ID_graduateInstitution:{
               onInitProp(propId);
               this._graduateInstitution = (String)value;
            ...
            case PROP_ID_practiceYears:{
               onInitProp(propId);
               this._practiceYears = (Integer)value;
     ...
     * 毕业院校: GRADUATE_INSTITUTION
     */
    public void setGraduateInstitution(String value){
     ...
     * 从业年限: PRACTICE_YEARS
     */
    public void setPracticeYears(Integer value){
