package com.fliad.biz.dao.entity._gen;
...
import com.fliad.biz.dao.entity.BizNotice;
...
public class _BizNotice extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_image = 3;
    ...
    /* 摘要: DIGEST VARCHAR */
    public static final String PROP_NAME_digest = "digest";
    public static final int PROP_ID_digest = 5;
    ...
    public static final int PROP_ID_sortCode = 9;
    ...
    public static final int PROP_ID_extJson = 11;
    
    /* 删除标志: DELETE_FLAG VARCHAR */
    public static final String PROP_NAME_deleteFlag = "deleteFlag";
    public static final int PROP_ID_deleteFlag = 12;
    ...
    public static final int PROP_ID_createUser = 14;
    ...
    public static final int PROP_ID_updateUser = 16;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_digest] = PROP_NAME_digest;
          PROP_NAME_TO_ID.put(PROP_NAME_digest, PROP_ID_digest);
    ...
    protected BizNotice newInstance(){
    ...
    @Override
    public BizNotice cloneInstance() {
        BizNotice entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "com.fliad.biz.dao.entity.BizNotice";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_digest:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_digest));
               }
               setDigest(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_digest:{
               onInitProp(propId);
               this._digest = (java.lang.String)value;
    ...
    public final void setDigest(java.lang.String value){
        if(onPropSet(PROP_ID_digest,value)){
            this._digest = value;
            internalClearRefs(PROP_ID_digest);
