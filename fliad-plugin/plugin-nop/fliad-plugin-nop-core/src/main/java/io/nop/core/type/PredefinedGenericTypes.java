...
public class PredefinedGenericTypes {
    ...
    public static final PredefinedRawType CLONEABLE_TYPE = javaType(Cloneable.class,"CLONEABLE_TYPE");

    public static final PredefinedRawType COMPARABLE_TYPE = javaType(Comparable.class,"COMPARABLE_TYPE");

    public static final PredefinedRawType RUNNABLE_TYPE = javaType(Runnable.class,"RUNNABLE_TYPE");

    public static final PredefinedRawType NUMBER_TYPE = javaType(Number.class,"NUMBER_TYPE");
    ...
    public static final PredefinedRawType PAIR_TYPE = javaType(Pair.class,"PAIR_TYPE");

    public static final PredefinedRawType I_GENERIC_TYPE_TYPE = javaType(IGenericType.class,"I_GENERIC_TYPE_TYPE");
    ...
    public static final PredefinedRawType STD_DATA_TYPE_TYPE = javaType(StdDataType.class,"STD_DATA_TYPE_TYPE");

    public static final PredefinedRawType NOP_EXCEPTION_TYPE = javaType(NopException.class,"NOP_EXCEPTION_TYPE");
    ...
    public static final PredefinedRawType NOP_SCRIPT_ERROR_TYPE = javaType(io.nop.api.core.exceptions.NopScriptError.class,"NOP_SCRIPT_ERROR_TYPE");
      ...
      public static final PredefinedGenericType ARRAY_ANY_TYPE =
          arrayType(ANY_TYPE, Object[].class);
      ...
      public static final PredefinedGenericType ARRAY_BOOLEAN_TYPE =
          arrayType(BOOLEAN_TYPE, Boolean[].class);
      ...
      public static final PredefinedGenericType ARRAY_CHAR_TYPE =
          arrayType(CHAR_TYPE, Character[].class);
      ...
      public static final PredefinedGenericType ARRAY_BYTE_TYPE =
          arrayType(BYTE_TYPE, Byte[].class);
      ...
      public static final PredefinedGenericType ARRAY_SHORT_TYPE =
          arrayType(SHORT_TYPE, Short[].class);
      ...
      public static final PredefinedGenericType ARRAY_INT_TYPE =
          arrayType(INT_TYPE, Integer[].class);
      ...
      public static final PredefinedGenericType ARRAY_LONG_TYPE =
          arrayType(LONG_TYPE, Long[].class);
      ...
      public static final PredefinedGenericType ARRAY_FLOAT_TYPE =
          arrayType(FLOAT_TYPE, Float[].class);
      ...
      public static final PredefinedGenericType ARRAY_DOUBLE_TYPE =
          arrayType(DOUBLE_TYPE, Double[].class);
      ...
      public static final PredefinedGenericType ARRAY_STRING_TYPE =
          arrayType(STRING_TYPE, String[].class);
