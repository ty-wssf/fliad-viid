...
public class _SimsExamExtField extends AbstractOrmKeyValueTable{
    
    /* : EXAM_ID VARCHAR */
    public static final String PROP_NAME_examId = "examId";
    public static final int PROP_ID_examId = 2;
    ...
    protected static final List<String> PK_PROP_NAMES = Arrays.asList(PROP_NAME_examId,PROP_NAME_fieldName);
    protected static final int[] PK_PROP_IDS = new int[]{PROP_ID_examId,PROP_ID_fieldName};
    ...
    /* : NOP_TENANT_ID */
    private String _nopTenantId;
    

    public _SimsExamExtField(){
        // for debug
    }

    protected SimsExamExtField newInstance(){
       return new SimsExamExtField();
    }

    @Override
    public SimsExamExtField cloneInstance() {
        SimsExamExtField entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.app.SimsExamExtField";
    }
    ...
    public boolean orm_isPrimary(int propId) {
            ...
            return propId == PROP_ID_examId || propId == PROP_ID_fieldName;
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_stringValue:{
               onInitProp(propId);
               this._stringValue = (String)value;
            ...
            case PROP_ID_nopTenantId:{
               onInitProp(propId);
               this._nopTenantId = (String)value;
     ...
     * : NOP_TENANT_ID
     */
    public void setNopTenantId(String value){
