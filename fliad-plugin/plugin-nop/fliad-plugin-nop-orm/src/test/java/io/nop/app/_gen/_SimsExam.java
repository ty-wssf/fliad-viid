...
public class _SimsExam extends DynamicOrmEntity{
    ...
    protected static final List<String> PK_PROP_NAMES = Arrays.asList(PROP_NAME_examId);
    protected static final int[] PK_PROP_IDS = new int[]{PROP_ID_examId};
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_examScoreScale:{
               onInitProp(propId);
               this._examScoreScale = (Byte)value;
     ...
     * : EXAM_SCORE_SCALE
     */
    public void setExamScoreScale(Byte value){
   ...
   public String getExtFldA(){
      return (String)internalGetAliasValue("ext.fldA.string");
   }

   public void setExtFldA(String value){
      internalSetAliasValue("ext.fldA.string",value);
   }

   public String getExtFldC(){
      return (String)internalGetAliasValue("ext.fldC.string");
   }

   public void setExtFldC(String value){
   ...
   static{
         ...
         COMPONENT_PROP_ID_MAP_examScoreDecimal.put(io.nop.orm.component.FloatingScaleDecimal.PROP_NAME_value,PROP_ID_examScore);
      
         COMPONENT_PROP_ID_MAP_examScoreDecimal.put(io.nop.orm.component.FloatingScaleDecimal.PROP_NAME_scale,PROP_ID_examScoreScale);
      
   }

   public io.nop.orm.component.FloatingScaleDecimal getExamScoreDecimal(){
      if(_examScoreDecimal == null){
          _examScoreDecimal = new io.nop.orm.component.FloatingScaleDecimal();
