...
public class _TestOrmTable extends DynamicOrmEntity{
     ...
     * : CLOB_COL
     */
    public void setClobCol(String value){
     ...
     * : JSON_LIST_COL
     */
    public void setJsonList(String value){
     ...
     * : NOP_SHARD
     */
    public void setNopShard(String value){
     ...
     * 
     */
    public TestOrmTable getParent(){
       return (TestOrmTable)internalGetRefEntity(PROP_NAME_parent);
    }

    public void setParent(TestOrmTable refEntity){
