...
public class _TestOrmMethod extends DynamicOrmEntity{
    ...
    private final OrmEntitySet<test.entity.TestOrmMethodParam> _methodParams = new OrmEntitySet<>(this, PROP_NAME_methodParams,
        null, null,test.entity.TestOrmMethodParam.class);
