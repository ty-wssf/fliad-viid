...
public abstract class _DialectErrorCodeModel extends io.nop.core.resource.component.AbstractComponentModel {
     ...
     * 
     */
    private java.util.Set<String> _values ;
    ...
    public Boolean getUseSqlState(){
      return _useSqlState;
    }

    
    public void setUseSqlState(Boolean value){
        checkAllowChange();
    ...
    public void setValues(java.util.Set<String> value){
        checkAllowChange();
