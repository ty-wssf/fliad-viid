...
public abstract class _DialectModel extends io.nop.core.resource.component.AbstractComponentModel {
     ...
     * 
     */
    private String _allSchemaPattern ;
     ...
     * 
     */
    private java.util.Set<String> _dbProductNames ;
     ...
     */
    private Boolean _defaultNullsFirst ;
     ...
     */
    private String _geometryTypeHandler ;
     ...
     * 
     */
    private String _jdbcUrlPattern ;
     ...
     * 
     */
    private String _jsonTypeHandler ;
     ...
     */
    private Character _keywordQuote ;
     ...
     */
    private Boolean _keywordUnderscore  = true;
     ...
     */
    private Integer _maxStringSize ;
     ...
     * 
     */
    private String _paginationHandler ;
     ...
     */
    private java.util.Map<String, String> _rename ;
     ...
     */
    private java.util.Set<String> _reservedKeywords ;
     ...
     * 
     */
    private String _sqlExceptionTranslator ;
     ...
     */
    private Integer _streamingFetchSize ;
    ...
    public String getAllSchemaPattern(){
      return _allSchemaPattern;
    }

    
    public void setAllSchemaPattern(String value){
        checkAllowChange();
    ...
    public java.util.Set<String> getDbProductNames(){
      return _dbProductNames;
    }

    
    public void setDbProductNames(java.util.Set<String> value){
        checkAllowChange();
    ...
    public Boolean getDefaultNullsFirst(){
      return _defaultNullsFirst;
    }

    
    public void setDefaultNullsFirst(Boolean value){
        checkAllowChange();
    ...
    public String getGeometryTypeHandler(){
      return _geometryTypeHandler;
    }

    
    public void setGeometryTypeHandler(String value){
        checkAllowChange();
    ...
    public void setJdbcUrlPattern(String value){
        checkAllowChange();
    ...
    public String getJsonTypeHandler(){
      return _jsonTypeHandler;
    }

    
    public void setJsonTypeHandler(String value){
        checkAllowChange();
    ...
    public Character getKeywordQuote(){
      return _keywordQuote;
    }

    
    public void setKeywordQuote(Character value){
        checkAllowChange();
    ...
    public Boolean getKeywordUnderscore(){
      return _keywordUnderscore;
    }

    
    public void setKeywordUnderscore(Boolean value){
        checkAllowChange();
    ...
    public void setMaxBytesSize(Integer value){
        checkAllowChange();
    ...
    public void setMaxStringSize(Integer value){
        checkAllowChange();
    ...
    public void setPaginationHandler(String value){
        checkAllowChange();
    ...
    public java.util.Map<String, String> getRename(){
      return _rename;
    }

    
    public void setRename(java.util.Map<String, String> value){
        checkAllowChange();
    ...
    public java.util.Set<String> getReservedKeywords(){
      return _reservedKeywords;
    }

    
    public void setReservedKeywords(java.util.Set<String> value){
        checkAllowChange();
    ...
    public String getSqlExceptionTranslator(){
      return _sqlExceptionTranslator;
    }

    
    public void setSqlExceptionTranslator(String value){
        checkAllowChange();
    ...
    public void setStreamingFetchSize(Integer value){
        checkAllowChange();
    ...
    public String getUpsertHandler(){
      return _upsertHandler;
    }

    
    public void setUpsertHandler(String value){
        checkAllowChange();
