...
public abstract class _ExcelSheetOptions extends io.nop.core.resource.component.AbstractComponentModel {
     ...
     * 
     */
    private Integer _splitHorizontal ;
     ...
     * 
     */
    private Integer _splitVertical ;
    ...
    public Integer getSplitHorizontal(){
      return _splitHorizontal;
    }

    
    public void setSplitHorizontal(Integer value){
        checkAllowChange();
    ...
    public Integer getSplitVertical(){
      return _splitVertical;
    }

    
    public void setSplitVertical(Integer value){
        checkAllowChange();
