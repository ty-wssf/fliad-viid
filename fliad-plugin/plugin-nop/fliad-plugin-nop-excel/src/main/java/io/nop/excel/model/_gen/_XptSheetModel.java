...
public abstract class _XptSheetModel extends io.nop.core.resource.component.AbstractComponentModel {
     ...
     * 
     */
    private Boolean _defaultColExtendForSibling ;
     ...
     * 
     */
    private Boolean _defaultRowExtendForSibling ;
    ...
    public Boolean getDefaultColExtendForSibling(){
      return _defaultColExtendForSibling;
    }

    
    public void setDefaultColExtendForSibling(Boolean value){
        checkAllowChange();
    ...
    public Boolean getDefaultRowExtendForSibling(){
      return _defaultRowExtendForSibling;
    }

    
    public void setDefaultRowExtendForSibling(Boolean value){
        checkAllowChange();
    ...
    public String getLoopIndexName(){
      return _loopIndexName;
    }

    
    public void setLoopIndexName(String value){
        checkAllowChange();
    ...
    public String getLoopItemsName(){
      return _loopItemsName;
    }

    
    public void setLoopItemsName(String value){
        checkAllowChange();
