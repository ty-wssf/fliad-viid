...
public abstract class _ExcelPageBreaks extends io.nop.core.resource.component.AbstractComponentModel {
     ...
     * 
     */
    private java.util.List<Integer> _cols ;
     ...
     * 
     */
    private java.util.List<Integer> _rows ;
    ...
    public java.util.List<Integer> getCols(){
      return _cols;
    }

    
    public void setCols(java.util.List<Integer> value){
        checkAllowChange();
    ...
    public java.util.List<Integer> getRows(){
      return _rows;
    }

    
    public void setRows(java.util.List<Integer> value){
        checkAllowChange();
