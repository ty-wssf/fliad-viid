...
public abstract class _XptCellModel extends io.nop.core.resource.component.AbstractComponentModel {
     ...
     */
    private Boolean _colExtendForSibling ;
     ...
     */
    private Integer _expandInplaceCount ;
     ...
     * 控制展开表达式最多返回多少行
     */
    private Integer _expandMaxCount ;
     ...
     */
    private Integer _expandMinCount ;
     ...
     */
    private Boolean _exportFormattedValue ;
     ...
     * 导出到Excel时保持公式
     */
    private Boolean _exportFormula ;
     ...
     */
    private Boolean _keepExpandEmpty ;
     ...
     */
    private Boolean _rowExtendForSibling ;
    ...
    public Boolean getColExtendForSibling(){
    ...
    public Integer getExpandInplaceCount(){
      return _expandInplaceCount;
    }

    
    public void setExpandInplaceCount(Integer value){
        checkAllowChange();
    ...
    public Integer getExpandMaxCount(){
      return _expandMaxCount;
    }

    
    public void setExpandMaxCount(Integer value){
        checkAllowChange();
    ...
    public Integer getExpandMinCount(){
      return _expandMinCount;
    }

    
    public void setExpandMinCount(Integer value){
        checkAllowChange();
    ...
    public Boolean getExportFormattedValue(){
    ...
    public Boolean getKeepExpandEmpty(){
    ...
    public Boolean getRowExtendForSibling(){
