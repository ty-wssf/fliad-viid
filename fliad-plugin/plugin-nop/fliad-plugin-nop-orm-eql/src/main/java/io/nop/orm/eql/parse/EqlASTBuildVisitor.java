...
public class EqlASTBuildVisitor extends _EqlASTBuildVisitor {
     ...
     * rules: sqlAggregateFunction
     */
    public boolean SqlAggregateFunction_selectAll(Token token) {
     ...
     */
    public boolean SqlBetweenExpr_not(Token token) {
     ...
     */
    public boolean SqlBooleanLiteral_value(Token token) {
     ...
     */
    public boolean SqlInQueryExpr_not(Token token) {
        return isToken(token, EqlParser.NOT);
    }
     ...
     */
    public boolean SqlInValuesExpr_not(Token token) {
        return isToken(token, EqlParser.NOT);
    }
     ...
     * rules: SqlIsNullExpr
     */
    public boolean SqlIsNullExpr_not(Token token) {
        return isToken(token, EqlParser.NOT);
    }
     ...
     * rules: SqlLikeExpr
     */
    public boolean SqlLikeExpr_not(Token token) {
        return isToken(token, EqlParser.NOT);
    }
     ...
     */
    public boolean SqlOrderByItem_asc(Token token) {
     ...
     * rules: sqlQuerySelect
     */
    public boolean SqlQuerySelect_selectAll(Token token) {
        return isToken(token, EqlParser.ASTERISK_);
    }
     ...
     * rules: sqlTypeExpr
     */
    public int SqlTypeExpr_precision(Token token) {
     ...
     * rules: sqlTypeExpr
     */
    public int SqlTypeExpr_scale(Token token) {
        int value = ConvertHelper.toPrimitiveInt(text(token),
     ...
     */
    public SqlDateTimeType SqlDateTimeLiteral_type(Token node) {
     ...
     */
    public SqlIntervalUnit SqlIntervalExpr_intervalUnit(ParseTree node) {
     ...
     * rules: SqlBinaryExpr
     */
    public io.nop.orm.eql.enums.SqlOperator SqlBinaryExpr_operator(Token token) {
     ...
     * rules: sqlUnaryExpr
     */
    public io.nop.orm.eql.enums.SqlOperator SqlUnaryExpr_operator(Token token) {
        return operator(token);
    }
     ...
     */
    public String SqlNumberLiteral_value(Token token) {
     ...
     * rules: sqlAlias
     */
    public String SqlAlias_alias(ParseTree node) {
     ...
     * rules: sqlDateTimeLiteral
     */
    public String SqlDateTimeLiteral_value(Token token) {
     ...
     */
    public String SqlStringLiteral_value(Token token) {
     ...
     * rules: sqlTypeExpr
     */
    public String SqlTypeExpr_name(ParseTree node) {
     ...
     */
    public String SqlBitValueLiteral_value(Token token) {
     ...
     */
    public String SqlHexadecimalLiteral_value(Token token) {
