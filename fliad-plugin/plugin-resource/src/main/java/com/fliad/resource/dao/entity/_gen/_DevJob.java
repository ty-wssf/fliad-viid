...
import com.fliad.resource.dao.entity.DevJob;
...
public class _DevJob extends DynamicOrmEntity{
    ...
    /* 任务类名: ACTION_CLASS VARCHAR */
    public static final String PROP_NAME_actionClass = "actionClass";
    public static final int PROP_ID_actionClass = 5;
    
    /* cron表达式: CRON_EXPRESSION VARCHAR */
    public static final String PROP_NAME_cronExpression = "cronExpression";
    public static final int PROP_ID_cronExpression = 6;
    
    /* 任务状态: JOB_STATUS VARCHAR */
    public static final String PROP_NAME_jobStatus = "jobStatus";
    public static final int PROP_ID_jobStatus = 7;
    
    /* 排序码: SORT_CODE INTEGER */
    public static final String PROP_NAME_sortCode = "sortCode";
    public static final int PROP_ID_sortCode = 8;
    
    /* 扩展信息: EXT_JSON CLOB */
    public static final String PROP_NAME_extJson = "extJson";
    public static final int PROP_ID_extJson = 9;
    
    /* 删除标志: DELETE_FLAG VARCHAR */
    public static final String PROP_NAME_deleteFlag = "deleteFlag";
    public static final int PROP_ID_deleteFlag = 10;
    ...
    public static final int PROP_ID_createUser = 12;
    ...
    public static final int PROP_ID_updateUser = 14;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_actionClass] = PROP_NAME_actionClass;
          PROP_NAME_TO_ID.put(PROP_NAME_actionClass, PROP_ID_actionClass);
      
          PROP_ID_TO_NAME[PROP_ID_cronExpression] = PROP_NAME_cronExpression;
          PROP_NAME_TO_ID.put(PROP_NAME_cronExpression, PROP_ID_cronExpression);
      
          PROP_ID_TO_NAME[PROP_ID_jobStatus] = PROP_NAME_jobStatus;
          PROP_NAME_TO_ID.put(PROP_NAME_jobStatus, PROP_ID_jobStatus);
    ...
    /* 任务状态: JOB_STATUS */
    private java.lang.String _jobStatus;
    ...
    protected DevJob newInstance(){
        DevJob entity = new DevJob();
    ...
    @Override
    public DevJob cloneInstance() {
        DevJob entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "com.fliad.resource.dao.entity.DevJob";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_actionClass:
               return getActionClass();
        
            case PROP_ID_cronExpression:
               return getCronExpression();
        
            case PROP_ID_jobStatus:
               return getJobStatus();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_actionClass:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_actionClass));
               }
               setActionClass(typedValue);
               break;
            }
            ...
            case PROP_ID_cronExpression:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_cronExpression));
               }
               setCronExpression(typedValue);
               break;
            }
            ...
            case PROP_ID_jobStatus:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_jobStatus));
               }
               setJobStatus(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_actionClass:{
               onInitProp(propId);
               this._actionClass = (java.lang.String)value;
            ...
            case PROP_ID_cronExpression:{
               onInitProp(propId);
               this._cronExpression = (java.lang.String)value;
            ...
            case PROP_ID_jobStatus:{
               onInitProp(propId);
               this._jobStatus = (java.lang.String)value;
     ...
     * 任务类名: ACTION_CLASS
     */
    public final java.lang.String getActionClass(){
         onPropGet(PROP_ID_actionClass);
         return _actionClass;
    }
     ...
     * 任务类名: ACTION_CLASS
     */
    public final void setActionClass(java.lang.String value){
        if(onPropSet(PROP_ID_actionClass,value)){
            this._actionClass = value;
            internalClearRefs(PROP_ID_actionClass);
    ...
    public final java.lang.String getCronExpression(){
         onPropGet(PROP_ID_cronExpression);
     ...
     * cron表达式: CRON_EXPRESSION
     */
    public final void setCronExpression(java.lang.String value){
        if(onPropSet(PROP_ID_cronExpression,value)){
            this._cronExpression = value;
            internalClearRefs(PROP_ID_cronExpression);
     ...
     * 任务状态: JOB_STATUS
     */
    public final void setJobStatus(java.lang.String value){
        if(onPropSet(PROP_ID_jobStatus,value)){
            this._jobStatus = value;
            internalClearRefs(PROP_ID_jobStatus);
