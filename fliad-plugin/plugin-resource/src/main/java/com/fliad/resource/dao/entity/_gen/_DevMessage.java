...
import com.fliad.resource.dao.entity.DevMessage;
...
public class _DevMessage extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_subject = 3;
    ...
    protected DevMessage newInstance(){
        DevMessage entity = new DevMessage();
    ...
    @Override
    public DevMessage cloneInstance() {
        DevMessage entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "com.fliad.resource.dao.entity.DevMessage";
    }
