...
import com.fliad.resource.dao.entity.SysResource;
...
public class _SysResource extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_createUser = 18;
    ...
    public static final int PROP_ID_updateUser = 20;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_visible] = PROP_NAME_visible;
          PROP_NAME_TO_ID.put(PROP_NAME_visible, PROP_ID_visible);
    ...
    protected SysResource newInstance(){
    ...
    @Override
    public SysResource cloneInstance() {
        SysResource entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "com.fliad.resource.dao.entity.SysResource";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_visible:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_visible));
               }
               setVisible(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_visible:{
               onInitProp(propId);
               this._visible = (java.lang.String)value;
     ...
     * 是否可见: VISIBLE
     */
    public final void setVisible(java.lang.String value){
        if(onPropSet(PROP_ID_visible,value)){
            this._visible = value;
            internalClearRefs(PROP_ID_visible);
