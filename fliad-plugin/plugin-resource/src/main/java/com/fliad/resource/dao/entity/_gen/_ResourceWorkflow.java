...
import com.fliad.resource.dao.entity.ResourceWorkflow;

// tell cpd to start ignoring code - CPD-OFF
/**
 *  工作流: resource_workflow
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ResourceWorkflow extends DynamicOrmEntity{
    ...
    /* 工作流设计的 JSON 内容: CONTENT VARCHAR */
    ...
    public _ResourceWorkflow(){
        // for debug
    }

    protected ResourceWorkflow newInstance(){
        ResourceWorkflow entity = new ResourceWorkflow();
    ...
    @Override
    public ResourceWorkflow cloneInstance() {
        ResourceWorkflow entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "com.fliad.resource.dao.entity.ResourceWorkflow";
    }
