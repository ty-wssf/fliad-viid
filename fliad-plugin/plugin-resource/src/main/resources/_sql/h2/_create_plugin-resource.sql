...
CREATE TABLE resource_datasource(
  ...
  SUBSCRIBE_DETAIL VARCHAR(255)   COMMENT '订阅类别' ,
  TYPE VARCHAR(50)   COMMENT '类型' ,
  REMARK VARCHAR(255)   COMMENT '备注' ,
  CONTENT VARCHAR(65535)   COMMENT '数据源配置的 JSON 内容' ,
  CREATE_TIME DATETIME   COMMENT '创建时间' ,
  CREATE_USER VARCHAR(20)   COMMENT '创建用户' ,
  UPDATE_TIME DATETIME   COMMENT '修改时间' ,
  UPDATE_USER VARCHAR(20)   COMMENT '修改用户' ,
  STATUS VARCHAR(10)   COMMENT '状态' ,
  SCRIPT_FILTER VARCHAR(65535)   COMMENT '脚本过滤器' ,
...
CREATE TABLE resource_workflow(
  ...
  STATUS VARCHAR(10)   COMMENT '状态' ,
  REMARK VARCHAR(255)   COMMENT '备注' ,
  CONTENT VARCHAR(65535)   COMMENT '工作流设计的 JSON 内容' ,
  CREATE_TIME DATETIME   COMMENT '创建时间' ,
  CREATE_USER VARCHAR(20)   COMMENT '创建用户' ,
  UPDATE_TIME DATETIME   COMMENT '修改时间' ,
  UPDATE_USER VARCHAR(20)   COMMENT '修改用户' ,
