...
public interface HikvisionCameraService extends IService<HikvisionCamera> {
     ...
     * @date 2025/09/27
     */
    Page<HikvisionCamera> page(HikvisionCameraPageParam viidHikvisionCameraPageParam);
     ...
     * @date 2025/09/27
     */
    void add(HikvisionCameraAddParam viidHikvisionCameraAddParam);
     ...
     * @date 2025/09/27
     */
    void edit(HikvisionCameraEditParam viidHikvisionCameraEditParam);
     ...
     * @date 2025/09/27
     */
    void delete(List<HikvisionCameraIdParam> viidHikvisionCameraIdParamList);
     ...
     * @date 2025/09/27
     */
    HikvisionCamera detail(HikvisionCameraIdParam viidHikvisionCameraIdParam);
