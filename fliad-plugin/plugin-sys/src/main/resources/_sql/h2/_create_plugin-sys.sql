...
CREATE TABLE sys_org(
  ...
  DIRECTOR_ID VARCHAR(20)   COMMENT '主管ID' ,
...
CREATE TABLE sys_position(
  ID VARCHAR(20) NOT NULL  COMMENT 'Id' ,
  ORG_ID VARCHAR(20)   COMMENT '组织id' ,
  NAME VARCHAR(255)   COMMENT '名称' ,
  CODE VARCHAR(255)   COMMENT '编码' ,
  CATEGORY VARCHAR(255)   COMMENT '分类' ,
  SORT_CODE INTEGER   COMMENT '排序码' ,
...
CREATE TABLE sys_user(
  ...
  EMP_NO VARCHAR(255)   COMMENT '员工编号' ,
  ENTRY_DATE VARCHAR(255)   COMMENT '入职日期' ,
  ORG_ID VARCHAR(20)   COMMENT '机构id' ,
  POSITION_ID VARCHAR(20)   COMMENT '职位id' ,
  POSITION_LEVEL VARCHAR(255)   COMMENT '职级' ,
  DIRECTOR_ID VARCHAR(20)   COMMENT '主管id' ,
  POSITION_JSON CLOB   COMMENT '兼任信息' ,
