...
import com.fliad.sys.dao.entity.SysGroup;
...
public class _SysGroup extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_remark = 3;
    
    /* 排序码: SORT_CODE INTEGER */
    public static final String PROP_NAME_sortCode = "sortCode";
    public static final int PROP_ID_sortCode = 4;
    ...
    public static final int PROP_ID_deleteFlag = 6;
    ...
    public static final int PROP_ID_createUser = 8;
    ...
    public static final int PROP_ID_updateUser = 10;
    ...
    protected SysGroup newInstance(){
    ...
    @Override
    public SysGroup cloneInstance() {
        SysGroup entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "com.fliad.sys.dao.entity.SysGroup";
    }
