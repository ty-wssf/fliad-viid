...
public class SysRoleGrantMobileMenuTreeResult {
    ...
    public List<SysRoleGrantMobileMenuResult> getMenu() {
        return menu;
    }

    public void setMenu(List<SysRoleGrantMobileMenuResult> menu) {
        this.menu = menu;
    }
    ...
    public static class SysRoleGrantMobileMenuResult {
        ...
        public List<SysRoleGrantMobileButtonResult> getButton() {
            return button;
        }

        public void setButton(List<SysRoleGrantMobileButtonResult> button) {
            this.button = button;
        }
