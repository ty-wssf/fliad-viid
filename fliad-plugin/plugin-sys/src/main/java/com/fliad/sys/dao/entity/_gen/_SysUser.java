package com.fliad.sys.dao.entity._gen;
...
import com.fliad.sys.dao.entity.SysUser;
...
public class _SysUser extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_createUser = 50;
    ...
    public static final int PROP_ID_updateUser = 52;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_empNo] = PROP_NAME_empNo;
          PROP_NAME_TO_ID.put(PROP_NAME_empNo, PROP_ID_empNo);
          ...
          PROP_ID_TO_NAME[PROP_ID_positionLevel] = PROP_NAME_positionLevel;
          PROP_NAME_TO_ID.put(PROP_NAME_positionLevel, PROP_ID_positionLevel);
      
          PROP_ID_TO_NAME[PROP_ID_directorId] = PROP_NAME_directorId;
          PROP_NAME_TO_ID.put(PROP_NAME_directorId, PROP_ID_directorId);
      
          PROP_ID_TO_NAME[PROP_ID_positionJson] = PROP_NAME_positionJson;
          PROP_NAME_TO_ID.put(PROP_NAME_positionJson, PROP_ID_positionJson);
    ...
    /* 职级: POSITION_LEVEL */
    private java.lang.String _positionLevel;
    
    /* 主管id: DIRECTOR_ID */
    private java.lang.String _directorId;
    
    /* 兼任信息: POSITION_JSON */
    private java.lang.String _positionJson;
    ...
    public String orm_entityName() {
      ...
      return "com.fliad.sys.dao.entity.SysUser";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_positionLevel:
               return getPositionLevel();
        
            case PROP_ID_directorId:
               return getDirectorId();
        
            case PROP_ID_positionJson:
               return getPositionJson();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_empNo:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_empNo));
               }
               setEmpNo(typedValue);
               break;
            }
            ...
            case PROP_ID_positionLevel:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_positionLevel));
               }
               setPositionLevel(typedValue);
               break;
            }
            ...
            case PROP_ID_directorId:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_directorId));
               }
               setDirectorId(typedValue);
               break;
            }
            ...
            case PROP_ID_positionJson:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_positionJson));
               }
               setPositionJson(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_empNo:{
               onInitProp(propId);
               this._empNo = (java.lang.String)value;
            ...
            case PROP_ID_entryDate:{
               onInitProp(propId);
               this._entryDate = (java.lang.String)value;
            ...
            case PROP_ID_positionLevel:{
               onInitProp(propId);
               this._positionLevel = (java.lang.String)value;
            ...
            case PROP_ID_directorId:{
               onInitProp(propId);
               this._directorId = (java.lang.String)value;
            ...
            case PROP_ID_positionJson:{
               onInitProp(propId);
               this._positionJson = (java.lang.String)value;
     ...
     * 员工编号: EMP_NO
     */
    public final java.lang.String getEmpNo(){
         onPropGet(PROP_ID_empNo);
         return _empNo;
    }
     ...
     * 员工编号: EMP_NO
     */
    public final void setEmpNo(java.lang.String value){
        if(onPropSet(PROP_ID_empNo,value)){
            this._empNo = value;
            internalClearRefs(PROP_ID_empNo);
     ...
     * 职级: POSITION_LEVEL
     */
    public final java.lang.String getPositionLevel(){
         onPropGet(PROP_ID_positionLevel);
     ...
     * 职级: POSITION_LEVEL
     */
    public final void setPositionLevel(java.lang.String value){
        if(onPropSet(PROP_ID_positionLevel,value)){
            this._positionLevel = value;
            internalClearRefs(PROP_ID_positionLevel);
     ...
     * 主管id: DIRECTOR_ID
     */
    public final java.lang.String getDirectorId(){
         onPropGet(PROP_ID_directorId);
         return _directorId;
    }
     ...
     * 主管id: DIRECTOR_ID
     */
    public final void setDirectorId(java.lang.String value){
        if(onPropSet(PROP_ID_directorId,value)){
            this._directorId = value;
            internalClearRefs(PROP_ID_directorId);
     ...
     * 兼任信息: POSITION_JSON
     */
    public final java.lang.String getPositionJson(){
         onPropGet(PROP_ID_positionJson);
         return _positionJson;
    }

    /**
     * 兼任信息: POSITION_JSON
     */
    public final void setPositionJson(java.lang.String value){
        if(onPropSet(PROP_ID_positionJson,value)){
            this._positionJson = value;
            internalClearRefs(PROP_ID_positionJson);
