...
import com.fliad.sys.dao.entity.SysPosition;
...
public class _SysPosition extends DynamicOrmEntity{
    ...
    protected SysPosition newInstance(){
    ...
    @Override
    public SysPosition cloneInstance() {
        SysPosition entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "com.fliad.sys.dao.entity.SysPosition";
    }
