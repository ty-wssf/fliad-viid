...
public class FunctionList extends JFrame {
	...
	public class FunctionPanel extends JPanel {
		...
		public FunctionPanel() {
			...
			playByDataTypeBtn = new JButton(Res.string().getPlayByDataType());
			downloadByDataTypeBtn = new JButton(Res.string().getDownloadByDataType());
			...
			add(playByDataTypeBtn);
			add(downloadByDataTypeBtn);
			...
			playByDataTypeBtn.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent arg0) {
					SwingUtilities.invokeLater(new Runnable() {
						public void run() {
							dispose();
							PlayByDataType.main(null);
						}
					});
				}
			});

			downloadByDataTypeBtn.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent arg0) {
					SwingUtilities.invokeLater(new Runnable() {
						public void run() {
							dispose();
							DownLoadByDataType.main(null);
						}
					});
				}
			});
		...
		private JButton playByDataTypeBtn;
		private JButton downloadByDataTypeBtn;
