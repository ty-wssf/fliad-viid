...
*/
    ...
    */
    ...
    /**
     * 输出信息,参见结构体定义 {@link com.netsdk.lib.structure.NET_ACCESSORY_OUTPUT_INFO}
    */
    ...
    */
    ...
    /**
     * 外部接入探测器信息,参见结构体定义 {@link com.netsdk.lib.structure.NET_ACCESSORY_EXTERNAL_SENSOR_INFO}
    */
    public NET_ACCESSORY_EXTERNAL_SENSOR_INFO[] stuExternalSensor = new NET_ACCESSORY_EXTERNAL_SENSOR_INFO[16];
    /**
     * 移动报警检测,参见结构体定义 {@link com.netsdk.lib.structure.NET_ACCESSORY_MOVEMENT_DETECTED_INFO}
    */
    ...
    */
    ...
    /**
     * 相机模组信息,参见结构体定义 {@link com.netsdk.lib.structure.NET_ACCESSORY_CAMERA_INFO}
    */
