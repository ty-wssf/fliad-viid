package com.fliad.auth.dao.entity._gen;
...
import com.fliad.auth.dao.entity.AuthThirdUser;

// tell cpd to start ignoring code - CPD-OFF
/**
 *  三方用户: AUTH_THIRD_USER
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _AuthThirdUser extends DynamicOrmEntity{
    
    /* Id: ID VARCHAR */
    public static final String PROP_NAME_id_ = "id_";
    public static final int PROP_ID_id_ = 1;
    
    /* 三方用户id: THIRD_ID VARCHAR */
    public static final String PROP_NAME_thirdId = "thirdId";
    public static final int PROP_ID_thirdId = 2;
    
    /* 系统用户id: USER_ID VARCHAR */
    ...
    public static final int PROP_ID_avatar = 4;
    ...
    public static final int PROP_ID_nickname = 6;
    
    /* 性别: GENDER VARCHAR */
    public static final String PROP_NAME_gender = "gender";
    public static final int PROP_ID_gender = 7;
    
    /* 分类: CATEGORY VARCHAR */
    public static final String PROP_NAME_category = "category";
    public static final int PROP_ID_category = 8;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_thirdId] = PROP_NAME_thirdId;
          PROP_NAME_TO_ID.put(PROP_NAME_thirdId, PROP_ID_thirdId);
    ...
    /* 三方用户id: THIRD_ID */
    private java.lang.String _thirdId;
    ...
    public _AuthThirdUser(){
        // for debug
    }

    protected AuthThirdUser newInstance(){
        AuthThirdUser entity = new AuthThirdUser();
    ...
    @Override
    public AuthThirdUser cloneInstance() {
        AuthThirdUser entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "com.fliad.auth.dao.entity.AuthThirdUser";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_thirdId:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_thirdId));
               }
               setThirdId(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_thirdId:{
               onInitProp(propId);
               this._thirdId = (java.lang.String)value;
     ...
     * 三方用户id: THIRD_ID
     */
    public final java.lang.String getThirdId(){
         onPropGet(PROP_ID_thirdId);
         return _thirdId;
    }
     ...
     * 三方用户id: THIRD_ID
     */
    public final void setThirdId(java.lang.String value){
        if(onPropSet(PROP_ID_thirdId,value)){
            this._thirdId = value;
            internalClearRefs(PROP_ID_thirdId);
