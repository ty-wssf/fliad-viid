 ...
 */
package com.fliad.auth.modular.login.service.impl;
...
import com.fliad.auth.modular.login.enums.AuthExceptionEnum;
...
import com.fliad.common.util.CommonCryptogramUtil;
...
public class AuthServiceImpl implements AuthService {
    ...
    private String execLoginC(SaBaseClientLoginUser saBaseClientLoginUser, String device) {
        ...
        // 执行登录
        StpClientUtil.login(saBaseClientLoginUser.getId(), device);
        // 填充C端用户信息并更新缓存
