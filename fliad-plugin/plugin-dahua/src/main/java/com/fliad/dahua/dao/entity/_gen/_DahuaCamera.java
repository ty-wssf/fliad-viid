package com.fliad.dahua.dao.entity._gen;
...
public class _DahuaCamera extends DynamicOrmEntity{
    ...
    protected DahuaCamera newInstance(){
        DahuaCamera entity = new DahuaCamera();
    ...
    @Override
    public DahuaCamera cloneInstance() {
        DahuaCamera entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "com.fliad.dahua.dao.entity.DahuaCamera";
    }
