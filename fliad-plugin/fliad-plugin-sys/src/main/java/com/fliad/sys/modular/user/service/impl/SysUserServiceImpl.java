...
import com.fliad.dev.api.DevEmailApi;
import com.fliad.dev.api.DevMessageApi;
import com.fliad.dev.api.DevSmsApi;
import com.fliad.mobile.api.MobileButtonApi;
import com.fliad.mobile.api.MobileMenuApi;
...
import com.fliad.sys.modular.resource.enums.SysResourceMenuTypeEnum;
...
import com.fliad.sys.modular.role.enums.SysRoleDataScopeCategoryEnum;
import com.fliad.sys.modular.role.service.SysRoleService;
import com.fliad.sys.modular.user.entity.SysUser;
import com.fliad.sys.modular.user.enums.SysUserStatusEnum;
import com.fliad.sys.modular.user.mapper.SysUserMapper;
    ...
    public List<String> getButtonCodeListGrantRole(String userId) {
        ...
        if (ObjectUtil.isNotEmpty(roleIdList)) {
            ...
            sysRelationService.getRelationListByObjectIdListAndCategory(roleIdList,
                ...
                if (ObjectUtil.isNotEmpty(sysRelation.getExtJson())) {
                    buttonIdList.addAll(JSONUtil.parseObj(sysRelation.getExtJson().replace("\\", "")).getBeanList("buttonInfo", String.class));
                }
            });
            if (ObjectUtil.isNotEmpty(buttonIdList)) {
    ...
    public List<JSONObject> getScopeListByMap(Map<String, List<SysRelation>> groupMap, String orgId) {
        ...
        groupMap.forEach((key, value) -> {
            ...
            value.forEach(sysRelation -> {
                JSONObject extJsonObject = JSONUtil.parseObj(sysRelation.getExtJson().replace("\\", ""));
