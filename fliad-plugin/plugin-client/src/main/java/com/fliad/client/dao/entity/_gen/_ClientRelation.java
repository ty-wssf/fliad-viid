package com.fliad.client.dao.entity._gen;
...
import com.fliad.client.dao.entity.ClientRelation;
...
public class _ClientRelation extends DynamicOrmEntity{
    ...
    public _ClientRelation(){
        // for debug
    }

    protected ClientRelation newInstance(){
        ClientRelation entity = new ClientRelation();
    ...
    @Override
    public ClientRelation cloneInstance() {
        ClientRelation entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "com.fliad.client.dao.entity.ClientRelation";
    }
