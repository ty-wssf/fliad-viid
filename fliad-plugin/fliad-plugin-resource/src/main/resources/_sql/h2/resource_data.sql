...
VALUES ('3887000000000000001', '1570687866138206209', '317770316242853888', 'SYS_ROLE_HAS_RESOURCE',
        '{"menuId":"317770316242853888","buttonInfo":[]}');

INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000003', '1570687866138206209', '1968883972877418496', 'SYS_ROLE_HAS_RESOURCE',
...
INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000004', '1570687866138206209', '1980000000000000001', 'SYS_ROLE_HAS_RESOURCE',
...
INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000011', '1570687866138206209', '/resource/workflow/page', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/workflow/page","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');

INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000012', '1570687866138206209', '/resource/workflow/add', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/workflow/add","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');

INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000013', '1570687866138206209', '/resource/workflow/delete', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/workflow/delete","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');

INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000014', '1570687866138206209', '/resource/workflow/copy', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/workflow/copy","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');

INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000025', '1570687866138206209', '/resource/datasource/page', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/datasource/page","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');

INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000026', '1570687866138206209', '/resource/datasource/add', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/datasource/add","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');

INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000027', '1570687866138206209', '/resource/datasource/edit', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/datasource/edit","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');

INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000028', '1570687866138206209', '/resource/datasource/delete', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/datasource/delete","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');

INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000029', '1570687866138206209', '/resource/datasource/detail', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/datasource/detail","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');

INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000030', '1570687866138206209', '/resource/datasource/copy', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/datasource/copy","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');

-- 添加模板相关权限
INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000031', '1570687866138206209', '/resource/datasource/installTemplate', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/datasource/installTemplate","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');

INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000032', '1570687866138206209', '/resource/datasource/templateList', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/datasource/templateList","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');

INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000033', '1570687866138206209', '/resource/workflow/installTemplate', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/workflow/installTemplate","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');

INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000034', '1570687866138206209', '/resource/workflow/templateList', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/workflow/templateList","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');

INSERT INTO sys_relation (ID, OBJECT_ID, TARGET_ID, CATEGORY, EXT_JSON)
VALUES ('3887000000000000036', '1570687866138206209', '/resource/workflow/edit', 'SYS_ROLE_HAS_PERMISSION',
        '{"apiUrl":"/resource/workflow/edit","scopeCategory":"SCOPE_ALL","scopeDefineOrgIdList":[]}');
