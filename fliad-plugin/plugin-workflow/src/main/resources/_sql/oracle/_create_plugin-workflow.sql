...
CREATE TABLE flow_definition(
  ...
  MODEL_VALUE VARCHAR2(40) NOT NULL ,
  CATEGORY VARCHAR2(100)  ,
  VERSION VARCHAR2(20) NOT NULL ,
  IS_PUBLISH CHAR(1) default 0  NOT NULL ,
  FORM_CUSTOM CHAR(1)  ,
  FORM_PATH VARCHAR2(100)  ,
  ACTIVITY_STATUS CHAR(1) default 1  NOT NULL ,
  LISTENER_TYPE VARCHAR2(100)  ,
  LISTENER_PATH VARCHAR2(400)  ,
  EXT VARCHAR2(500)  ,
  CREATE_TIME DATE  ,
...
CREATE TABLE flow_his_task(
  ...
  COOPERATE_TYPE CHAR(1) default 0  NOT NULL ,
...
CREATE TABLE flow_skip(
  ...
  NOW_NODE_TYPE CHAR(1)  ,
  NEXT_NODE_CODE VARCHAR2(100) NOT NULL ,
  NEXT_NODE_TYPE CHAR(1)  ,
